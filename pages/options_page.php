        ...
        <form action="" method="post">
            <div class="postbox">
                ...
                <table class="agm_tbl inside">
                    <tr>
                        ...
                        <td><input required type="number" min="1" name="div_width"
                                   value="<?php echo esc_attr($agm_options['div_width']); ?>">
                            <select name="div_width_unit">
                                <optgroup label="Unit"></optgroup>
                                <option <?php selected($agm_options['div_width_unit'], '1') ?> value="1"> px
                                </option>
                                <option <?php selected($agm_options['div_width_unit'], '2') ?> value="2"> %
                                </option>
                            </select> <i>Choose % (percent) to make it responsive</i></td>
                    </tr>
                    <tr>
                        <td>Map Canvas Height:</td>
                        <td><input required type="number" min="1" name="div_height"
                                   value="<?php echo esc_attr($agm_options['div_height']); ?>">
                            <i>Height will be in px</i>
                        </td>
                    </tr>
                    <tr>
                        <td>Border Color:</td>
                        <td><input placeholder="Color" type="text" id="agm_color_field" name="div_border_color"
                                   value="<?php echo esc_attr($agm_options['div_border_color']); ?>"><i
                                style="vertical-align: top">Border will be 1px solid. Leave empty to
                                disable.</i></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><label><input <?php checked($agm_options['disable_mouse_wheel'], '1') ?>
                                    type="checkbox" name="disable_mouse_wheel">Disable Mouse Wheel Zoom</label>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><label><input <?php checked($agm_options['disable_drag_mobile'], '1') ?>
                                    type="checkbox" name="disable_drag_mobile">Disable Dragging on Mobile
                                Devices</label></td>
                    </tr>
                </table>
            </div><!-- post box ends -->
                ...
                <table class="agm_tbl inside">
                    <tr>
                        ...
                        <td><input id="agm_lat" pattern="-?\d{1,3}\.\d+" title="Latitude"
                                   placeholder='33.123333' type="text" required name="map_Lat"
                                   value="<?php echo esc_attr($agm_options['map_Lat']); ?>"></td>
                    </tr>
                    <tr>
                        <td>Longitude:</td>
                        <td><input id="agm_lng" pattern="-?\d{1,3}\.\d+" title="Longitude"
                                   placeholder='77.456789' type="text" required name="map_Lng"
                                   value="<?php echo esc_attr($agm_options['map_Lng']); ?>"></td>
                    </tr>
                    <tr>
                        <td>Zoom Level: <b><i
                                    id="agm_zoom_pre"><?php echo esc_attr($agm_options['map_zoom']); ?></i></b>
                        </td>
                        <td><input title="Hold me and slide to change zoom" id="agm_zoom" type="range" max="21"
                                   min="1" required name="map_zoom"
                                   value="<?php echo esc_attr($agm_options['map_zoom']); ?>"></td>
                    </tr>
                    <tr>
                        <td>Disable Controls:</td>
                        <td><input <?php checked($agm_options['map_control_1'], '1') ?> type="checkbox"
                                                                                        name="map_control_1"
                                                                                        id="map_control_1"><label
                                for="map_control_1">Disable Pan Control</label><br>
                            <input <?php checked($agm_options['map_control_2'], '1') ?> type="checkbox"
                                                                                        name="map_control_2"
                                                                                        id="map_control_2"><label
                                for="map_control_2">Disable Zoom Control</label><br>
                            <input <?php checked($agm_options['map_control_3'], '1') ?> type="checkbox"
                                                                                        name="map_control_3"
                                                                                        id="map_control_3"><label
                                for="map_control_3">Disable MapType Control</label><br>
                            <input <?php checked($agm_options['map_control_4'], '1') ?> type="checkbox"
                                                                                        name="map_control_4"
                                                                                        id="map_control_4"><label
                                for="map_control_4">Disable StreetView Control</label><br>
                            <input <?php checked($agm_options['map_control_5'], '1') ?> type="checkbox"
                                                                                        name="map_control_5"
                    ...
                    <tr>
                        ...
                        <td><input placeholder="empty=auto" pattern="([A-Za-z\-]){2,5}"
                                   title="Language Code Like: en OR en-US" type="text" name="map_lang_code"
                                   value="<?php echo esc_attr($agm_options['map_lang_code']); ?>">
                    ...
                    <tr>
                        ...
                        <td><select name="map_type">
                                ...
                                <option <?php selected($agm_options['map_type'], '1') ?> value="1">ROADMAP
                                </option>
                                <option <?php selected($agm_options['map_type'], '2') ?> value="2">SATELLITE
                                </option>
                                <option <?php selected($agm_options['map_type'], '3') ?> value="3">HYBRID
                                </option>
                                <option <?php selected($agm_options['map_type'], '4') ?> value="4">TERRAIN
                                </option>
                            </select></td>
                    </tr>
                </table>
            ...
            <div class="postbox">
                ...
                <table class="agm_tbl inside">
                    <tr>
                        <td>Enable marker:</td>
                        <td><input <?php checked($agm_options['marker_on'], '1') ?> type="checkbox"
                                                                                    name="marker_on"
                                                                                    id="agm_mark_on">
                    ...
                    <tr>
                        <td>Marker Title:</td>
                        <td><input style="width: 40%" maxlength="200" type="text" name="marker_title"
                                   value="<?php echo esc_attr($agm_options['marker_title']); ?>">
                    ...
                    <tr>
                        ...
                        <td><select name="marker_color">
                                ...
                                <option <?php selected($agm_options['marker_color'], '1') ?> value="1">Default
                                </option>
                                <option <?php selected($agm_options['marker_color'], '2') ?> value="2">Light
                                    Red
                                </option>
                                <option <?php selected($agm_options['marker_color'], '3') ?> value="3">Black
                                </option>
                                <option <?php selected($agm_options['marker_color'], '4') ?> value="4">Gray
                                </option>
                                <option <?php selected($agm_options['marker_color'], '5') ?> value="5">Orange
                                </option>
                                <option <?php selected($agm_options['marker_color'], '6') ?> value="6">White
                                </option>
                                <option <?php selected($agm_options['marker_color'], '7') ?> value="7">Yellow
                                </option>
                                <option <?php selected($agm_options['marker_color'], '8') ?> value="8">Purple
                                </option>
                                <option <?php selected($agm_options['marker_color'], '9') ?> value="9">Green
                                </option>
                            </select></td>
                    </tr>
                </table>
            ...
            <div class="postbox">
                ...
                <table class="agm_tbl inside">
                    <tr>
                        ...
                        <td><input <?php checked($agm_options['info_on'], '1') ?> type="checkbox" name="info_on"
                                                                                  id="agm_info_on">
                    ...
                    <tr>
                        ...
                        <td><input <?php checked($agm_options['info_state'], '1') ?> type="checkbox"
                                                                                     name="info_state"
                                                                                     id="agm_info_state">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $this->get_text_editor(stripslashes($agm_options['info_text'])); ?>
